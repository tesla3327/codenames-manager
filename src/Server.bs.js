...
Express.App[/* get */4](app, "/hello", Express.Middleware[/* from */5]((function (_, _$1) {
...
Express.App[/* use */0](app, Express.Static[/* asMiddleware */4](Express.Static[/* make */3](publicDir, Express.Static[/* defaultOptions */0](/* () */0))));
...
function onListen() {
  console.log("Listening at " + (host + (":" + String(3333))));
  return /* () */0;
}

http.listen(3333, host, onListen);
